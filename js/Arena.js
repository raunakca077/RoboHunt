//Taken this part of code as help from github to locate the positions of the entities.
...
function Arena(ctx) {
    ...
    this._init = function() {
        ...
        _this = this;
        this.ctx = ctx;
        this.totalNoOfTiles = Math.round(this.ctx.canvas.width / 20);
        this.mapArray = [];
     ...
     this._createObstacle({x: 600, y: 435}, 170, 163);
        ...
        this.grass.src = 'images/platform.png';
        this.sand.src = 'images/wall.png';
        this.verticalSand.src = 'images/vertical.png';
        this.verticalSandRight.src = 'images/vertical.png';
        this.background.src = 'images/cone.png';
        this.bigStone.src = 'images/obstacle2.png';
    ...
    this._createObstacle = function (obstaclePosition, obstacleWidth, obstacleHeight) {
        ...
        var fromY =  Math.round(obstaclePosition.y / 32) - 2;
        var fromX = Math.round(obstaclePosition.x / 32) - 2;
        var toY = Math.round((obstaclePosition.y + obstacleHeight) / 32) - 3;
        var toX = Math.round((obstaclePosition.x + obstacleWidth) / 32) - 2;
