...
function Proto(ctx, startPosition, canvas, camera, collisionHandler, resources) {
    var _this = this;
    ...
    this._init = function() {
        ...
        this.noOfFrames = 1;//ysha pe 4 tha
        ...
        this.weapon = new Weapon(this.ctx, this.collisionHandler, 'action', this.resources);
    ...
    this._drawActor = function() {
        ...
        _this.ctx.drawImage(
            _this.resources.getImage('aircraft'),
